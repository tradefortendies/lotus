...
const lilyPubKey = new PublicKey(
    "3NoPerEGS1JpPA6FGYpPfKJ8QUkBjYPngST2pwpQt7ED"
);
...
export const Community = () => {
    ...
    const getMetadata = async (tokenPubKey: string) => {
        try {
            ...
            const dataReq = await fetch(resp.data.data.uri).then((res) =>
                res.json()
            );
        ...
        while (sales.length < 3) {
            ...
            if (
                ...
                sales.push({
                    ...
                    signature,
                    collection:
                        metadata.collection.name === "Lotus Gang"
                            ? "lotus-gang"
                            : "lily",
                    name: metadata.name,
                ...
                <div className="lg:w-1/2">
                    ...
                    >
                        ...
                        <p className="mt-12 text-2xl text-center lg:pr-16 lg:text-3xl lg:text-left">
                            We have holders all over the world and we are
                            growing every day.
                        </p>
                    </Fade>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="z-20 flex flex-col items-center justify-center gap-4 transition-opacity duration-700 opacity-0 -translate-y-7 lg:-translate-y-16 group-hover:opacity-100">
                                ...
                                <h3 className="text-3xl text-white font-base">
                                    Coming Soon.
                                </h3>
                            </div>
